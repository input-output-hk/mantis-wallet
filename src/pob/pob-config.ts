import {PobChain, POB_CHAINS, PobChainId} from './pob-chains'

export const PROVER_API_REQUEST_TIMEOUT = 10000

export const PROVER_POLLING_RATE = 2000

export const CHAINS_TO_USE_IN_POB: PobChain[] = [POB_CHAINS.BTC_TESTNET, POB_CHAINS.ETH_TESTNET]
...
export const MIDNIGHT_TOKEN_CONTRACTS: Record<PobChainId, string> = {
