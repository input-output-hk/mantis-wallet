  ...
  steps.commands = {
    ...
    electron-darwin = {
      ...
      command = ''
        ...
        export MANTIS_DIST_DIR=$PWD/mantis-dist
        ...
        nix-shell --pure --keep SSH_AUTH_SOCK --run yarn
        nix-shell --keep MANTIS_DIST_DIR --pure --run "yarn package-darwin"
        nix-shell --run "npx electron-builder --publish never --prepackaged dist/Mantis-Wallet-darwin-x64 --mac dmg"
      '';
    ...
    electron-linux = {
      ...
      command = ''
        ...
        nix-shell --keep MANTIS_DIST_DIR --pure --run "yarn package-linux"
        nix-shell --pure --run "npx electron-builder --publish never --prepackaged dist/Mantis-Wallet-linux-x64 --linux AppImage"
      '';
    ...
    electron-win = {
      ...
      command = ''
        ...
        nix-shell --keep MANTIS_DIST_DIR --pure --run "yarn package-win"
        nix-shell --pure --run "npx electron-builder --publish never --prepackaged dist/Mantis-Wallet-win32-x64 --win --x64"
      '';
